...
<b> At this point, we should have established connectivity between the two computer sets across both network subnets. To verify the network connectivity, click on PC1, go to the "Desktop" tab, and then select "Command Prompt." In the command prompt, try pinging either PC3 or PC4. As demonstrated in the screenshot, the ping is successful, confirming that communication between the two subnets is working as intended..<b/> 
<br>
<br>
